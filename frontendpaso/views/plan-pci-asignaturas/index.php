...
/* @var $searchModel backend\models\PlanPciAsignaturasSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'PCI - ASIGNATURAS: '.$modelPci->nivel->nombre;
$pdfTitle = $this->title;
...
?>
<div class="plan-pci-asignaturas-index">

    <div class="container">
    <p>
        <?= Html::a('Crear Asignatura - PCI', ['create','id' => $modelPci->id], ['class' => 'btn btn-success']) ?>
    </p>

            ...
            <table class="table table-hover my-text-medium">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><strong>DURACIÓN PREVISTA: </strong>3 TRIMESTRES </td>
                    </tr>
                    <tr>
...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12" style="margin-left: 20px; margin-right: 20px; margin-bottom: 10px">
        ...
        <h6 class="my-text-medium">Asignar NEE a la asignatura:</h6>
        ...
        <!-- TABLA DE ASIGNACION MATERIA PARA NEE -->

        <div class="table responsive" style="width: 95%">
            <table class="table table-hover table-striped table-bordered">
                <thead>
                    <tr>
                        <th width="150px">Materia</th>
                ...
                <tbody>
...

                    {
                        ...
                        if ($materia['grado'] == 1 || $materia['grado'] == 2 || $materia['grado'] == 3) {
                        ...
                        value="' . $materia['clase_id'] . ' checked">';
                        }
                        echo '</td>';
                        echo '</tr>';
                    }
        ...
        <!-- FIN TABLA DE ASIGNACION PARA NEE -->
                    ...
                    ?>
                        <tr class="text-center">
                            ...
                            <td><?= strtoupper($seleccionada->clase->ismAreaMateria->materia->nombre) .
                                    ' / ' . $seleccionada->clase->profesor->last_name . ' ' . $seleccionada->clase->profesor->x_first_name ?>
                            </td>

                            <td>
                                <?= $seleccionada->grado_nee ?>
                            </td>

                            <td>
                                <?php
                                // echo "<pre>";
                                // print_r($seleccionada->diagnostico_inicia);
                                // die();

                                if ($seleccionada->diagnostico_inicia == 'Aquí su diagnóstico') {
                                    echo '<i  title=" ' . $seleccionada->diagnostico_inicia . '" type="button" class="fas fa-exclamation-triangle" style="color:#ff9e18 " ></i>';
                                } else {
                                    echo '<i title=" ' . $seleccionada->diagnostico_inicia . '" type="button" class="fas fa-check-circle" style="color:green" ></i>';
                                }
                                ?>
                            </td>
                            ...
                            <td>
                                ...
                                if ($seleccionada->diagnostico_finaliza == null) {
                                    echo '<i title="' . $seleccionada->diagnostico_finaliza . '" type="button" class="fas fa-exclamation-triangle" style="color:#ff9e18 " ></i>';
                                } else {
                                    echo '<i title="' . $seleccionada->diagnostico_finaliza . '" type="button" class="fas fa-check-circle" style="color:green" ></i>';
                                }
                                ?>
                            </td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="text-align: start">
                                            ...
                                            <label>GRADO:</label>
                                            <?=
                                            Html::input('number', 'grado_nee', $seleccionada->grado_nee, [
                                                'class' => 'form-control',
                                                'min' => '1', 'max' => '3'
                                            ])
                                            ?>
                                            ...
                                            <?=
                                            Html::input('text', 'fecha_inicia', $seleccionada->fecha_inicia, [
                                                'class' => 'form-control',
                                                'disabled' => true,
                                                'readonly' => true
                                            ])
                                            ...
                                            <?=
                                            Html::textarea('diagnostico_inicia', $seleccionada->diagnostico_inicia, [
                                                'class' => 'form-control',
                                                'rows' => '3'
                                            ])
                                            ?>
                                            ...
                                            <?=
                                            Html::textarea('recomendacion_clase', $seleccionada->recomendacion_clase, [
                                                'class' => 'form-control',
                                                'rows' => '3'
                                            ])
                                            ?>
                                            ...
                                            <?=
                                            Html::textarea('diagnostico_finaliza', $seleccionada->diagnostico_finaliza, [
                                                'class' => 'form-control',
                                                'rows' => '3'
                                            ])
                                            ?>
...
<script>
    ...
    function ajaxInsertaMateria(claseId) {

...
/**
 * This is the model class for table "op_violence_modality".
 *
 * @property int $id
 ...
 */
class OpViolenceModality extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(OpPsychologicalAttention::className(), ['violence_modality_id' => 'id']);
    }

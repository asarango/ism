...
$this->title = 'Actualizando datos de Opciones: ';
        ...
        <div class="card shadow col-lg-8 col-md-8">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <?=
                    Html::a(
                        '<span class="badge rounded-pill" style="background-color: #9e28b5"><i class="fa fa-briefcase" aria-hidden="true"></i> Volver al Menú Opciones</span>',
                        ['index'],
                        ['class' => 'link']
                    );
                    ?>

 ...
 */
class ScholarisRepSabanaController extends Controller {
...
//        $html .= $this->materias($modelAreas, $modelAlumno, $modelBloque);
    ...
    private function detalle_area($areaId, $modelAlumno, $modelBloque) {
        ...
        foreach ($modelAlumno as $alumno) {
            ...
            if($alumno['isncription_state']){
                $html .= '<td class="conBorde centrarTexto">' . $i . '</td>';
                $html .= '<td class="conBorde">' . $alumno['last_name'] . ' ' . $alumno['first_name'] . ' ' . $alumno['middle_name'] . '</td>';
            }else{
                $html .= '<td class="conBorde centrarTexto" bgcolor="#FA8B8B">' . $i . '</td>';
                $html .= '<td class="conBorde" bgcolor="FA8B8B">' . $alumno['last_name'] . ' ' . $alumno['first_name'] . ' ' . $alumno['middle_name'] . '</td>';
            }
...
//            $html .= '<td class="centrarTexto">'.$modelMateria->mallaMateria->orden.'</td>';
    ...
    private function detalle_materia($clase, $modelAlumnos, $modelBloques){
        ...
        foreach ($modelAlumnos as $alumno) {
            ...
            $html .= '<td class="conBorde centrarTexto padding2">' . $nota['p1'] . '</td>';
            $html .= '<td class="conBorde centrarTexto padding2">' . $nota['p2'] . '</td>';
            $html .= '<td class="conBorde centrarTexto padding2">' . $nota['p3'] . '</td>';
            $html .= '<td class="conBorde centrarTexto padding2">' . $nota['pr1'] . '</td>';
            $html .= '<td class="conBorde centrarTexto padding2">' . $nota['pr180'] . '</td>';
            $html .= '<td class="conBorde centrarTexto padding2">' . $nota['ex1'] . '</td>';
            $html .= '<td class="conBorde centrarTexto padding2">' . $nota['ex120'] . '</td>';

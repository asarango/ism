 ...
 * @property ScholarisMallaArea[] $scholarisMallaAreas
 * @property ScholarisReporteNotasArea[] $scholarisReporteNotasAreas
 * @property ScholarisReporteNotasAreaPrimeros[] $scholarisReporteNotasAreaPrimeros
 */
class ScholarisArea extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'seccion_general' => 'Seccion General',
            'orden' => 'Orden',
        ];
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getScholarisMallaAreas()
    {
        return $this->hasMany(ScholarisMallaArea::className(), ['area_id' => 'id']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getScholarisReporteNotasAreaPrimeros()
    {
        return $this->hasMany(ScholarisReporteNotasAreaPrimeros::className(), ['area_id' => 'id']);
    }
}

 ...
 */
class InfLibretaPdfQ2V1 extends \yii\db\ActiveRecord {
        ...
        foreach ($areas as $ar) {
            if ($ar['se_imprime'] == true) {
                ...
                if ($ar['promedia'] == 1) {
                    ...
                    $html .= '<td class="bordesolido centrarTexto">' . $notasArea['p4'] . '</td>';
                    $html .= '<td class="bordesolido centrarTexto">' . $notasArea['p5'] . '</td>';
                    if (count($this->modelBloquesQ1) > 2) {
                        $html .= '<td class="bordesolido centrarTexto">' . $notasArea['p6'] . '</td>';
                    }
                    $html .= '<td class="bordesolido centrarTexto">' . $notasArea['pr2'] . '</td>';
                    $html .= '<td class="bordesolido centrarTexto">' . $notasArea['pr280'] . '</td>';
                    $html .= '<td class="bordesolido centrarTexto">' . $notasArea['ex2'] . '</td>';
                    $html .= '<td class="bordesolido centrarTexto">' . $notasArea['ex220'] . '</td>';
            ...
            foreach ($materias as $mat) {
                if ($mat['se_imprime'] == 1) {
                    ...
                    /*                     * ***** QUIMESTRE 2*********** */
                    $html .= '<td class="bordesolido centrarTexto">' . $notasM['p4'] . '</td>';
                    $html .= '<td class="bordesolido centrarTexto">' . $notasM['p5'] . '</td>';
                    if (count($this->modelBloquesQ1) > 2) {
                        $html .= '<td class="bordesolido centrarTexto">' . $notasM['p6'] . '</td>';
                    }
                    $html .= '<td class="bordesolido centrarTexto">' . $notasM['pr2'] . '</td>';
                    $html .= '<td class="bordesolido centrarTexto">' . $notasM['pr280'] . '</td>';
                    $html .= '<td class="bordesolido centrarTexto">' . $notasM['ex2'] . '</td>';
                    $html .= '<td class="bordesolido centrarTexto">' . $notasM['ex220'] . '</td>';
...
//        die();
        ...
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['p1'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['p2'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['pr1'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['pr180'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['ex1'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['ex120'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['q1'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['p4'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['p5'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['pr2'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['pr280'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['ex2'],2) . '</strong></td>';
        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['ex220'],2) . '</strong></td>';
        ...
        $equivalencia = $this->homologa_aprovechamiento($promedios['final_ano_normal']);
        $html .= '<td class="bordesolido tamano8 centrarTexto">' . $equivalencia . '</td>';
//        if (count($this->modelBloquesQ1) > 2) {
//            $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['p3'],2) . '</strong></td>';
//        }
        //$html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promediosPr1['pr1'],2) . '</strong></td>';
        //$html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promediosPr180['pr180'],2) . '</strong></td>';
//        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['pr1'],2) . '</strong></td>';
//        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['pr180'],2) . '</strong></td>';
//        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['ex1'],2) . '</strong></td>';
//        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['ex120'],2) . '</strong></td>';
...
//        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['p5'],2) . '</strong></td>';
//        if (count($this->modelBloquesQ1) > 2) {
//            $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['p6'],2) . '</strong></td>';
//        }
//        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['pr2'],2) . '</strong></td>';
//        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['pr280'],2) . '</strong></td>';
//        $html .= '<td class="bordesolido tamano12 centrarTexto" bgcolor="#eaeaea"><strong>' . number_format($promedios['ex2'],2) . '</strong></td>';
...
//        }
//        $html .= $this->devuelve_nota_promedio($notaF, 'pr1');$notasCompProy = $this->consulta_comportamientos_y_proyectos($alumnoId);
        ...
        if ($this->seccion != 'BACHILLERATO') {
            ...
            $html .= '<td class="bordesolido tamano10 centrarTexto" bgcolor="#eaeaea">' . $proyQ1['p1']['abreviatura'] . '</td>';
            ...
            $html .= '<td class="bordesolido tamano10 centrarTexto" bgcolor="#eaeaea">' . $proyQ1['p4']['abreviatura'] . '</td>';
        ...
        $html .= '<td class="tamano10 bordesolido centrarTexto" bgcolor="#eaeaea" colspan="">' . $notaC[0]['p1'] . '</td>';
        ...
        $html .= '<td class="tamano10 bordesolido centrarTexto" bgcolor="#eaeaea" colspan="">' . $notaC[0]['p4'] . '</td>';

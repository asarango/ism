...
$this->title = 'Actualizando datos de asignatura: ' . $model->name;
$this->params['breadcrumbs'][] = ['label' => 'Scholaris Materias', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->name, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'Update';
?>
<div class="scholaris-materia-update">
            ...
            <div class=" row align-items-center p-2">
                ...
                <div class="col-lg-11">
                    ...
                    <p>(
                        ...
                        ' <small>' . $model->name .
                            ' - ' .
                            'Comentario:' . $model->last_name .
                            ' - ' .
                            //'Currículo: ' . $model->curriculoNivel->name . ' - ' . $model->curriculoAsignatura->name . ' / ' .

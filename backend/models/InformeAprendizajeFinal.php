 ...
 */
class InformeAprendizajeFinal extends \yii\db\ActiveRecord {

    /**
     * Lists all ScholarisRepLibreta models.
     * @return mixed
     */
    public function genera_reporte_alumno($alumno, $paralelo) {
        ...
        foreach ($modelMallaArea as $area) {
            ...
            if ($area['se_imprime'] == true) {
                ...
                if ($area['promedia'] == true) {
                    ...
                    $notaArea = $sentenciasNxx->get_nota_area($area['id']);
                    $notaq1 = $notaArea['q1'];
                    $notaq2 = $notaArea['q2'];
...
//                $notas = $sentenciaNotas->calcula_nota($alumno, $clase['materia_id'], $periodoCodigo);
                    $notasMateria = $sentenciasNxx->get_nota_materia($clase['materia_id'], $clase['grupo_id']);
                    $mq1 = $notasMateria['q1'];
                    $mq2 = $notasMateria['q2'];
        ...
        $html .= '<td class="tamano8 conBorde centrarTexto"><strong>'.$sentenciasNxx->q1.'</strong></td>';
        $html .= '<td class="tamano8 conBorde centrarTexto"><strong>'.$sentenciasNxx->q2.'</strong></td>';
        $html .= '<td class="tamano8 conBorde centrarTexto"><strong>'.$sentenciasNxx->finalNormal.'</strong></td>';
        ...
        $html .= '<td class="tamano8 conBorde centrarTexto"></td>';
        $html .= '<td class="tamano8 conBorde centrarTexto"></td>';
        $html .= '<td class="tamano8 conBorde centrarTexto"><strong>'.number_format($sentenciasNxx->notaFinalAprovechamiento,2).'</strong></td>';

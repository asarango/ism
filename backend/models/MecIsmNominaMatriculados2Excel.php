 ...
 */
class MecIsmNominaMatriculados2Excel extends \yii\db\ActiveRecord {
    ...
    private function genera_reporte_excel() {
        ...
        $filename = 'NominaMatriculado.xls';
        ...
        $data .= $this->genera_cuerpo('NÓMINA DE ESTUDIANTES MATRICULADOS');
    ...
    private function genera_cabecera() {
        ...
        $html = '';
        $html .= '<img src="' . $banner . '">';
        $html .= '<apex:image url="http://images.google.com/intl/en_ALL/images/logos/images_logo_lg.gif"/>';

...
$this->title = 'Valor Institucional: '.$modelCabecera->planificacion_titulo;
$pdfTitle = $this->title;
...
<div class="plan-pdu-valores-index">
    
    <div class="container">
    <p>
        <?= Html::a('Crear Valor', ['create','id' => $modelCabecera->id], ['class' => 'btn btn-success']) ?>
    </p>

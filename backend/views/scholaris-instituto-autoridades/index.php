...
/* @var $searchModel backend\models\ScholarisInstitutoAutoridadesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Autoridades del Instituto';
$pdfTitle = $this->title;
...
?>
<div class="scholaris-instituto-autoridades-index">
    ...
    <p>
        <?= Html::a('Create Scholaris Instituto Autoridades', ['create','id' => $id, 'periodoId' => $periodoId], ['class' => 'btn btn-success']) ?>
    </p>

...
<div class="form-group"> 
    ...
    <button type="submit" class="btn btn-outline-warning" 
            style="margin-top: 10px"
            onclick="grabarAgencia(<?= $registroId ?>)">
        Guardar
    </button>
</div>
...
<div class="form-group"> 
    ...
    <button type="submit" class="btn btn-outline-warning" 
            style="margin-top: 10px"
            onclick="grabarPreguntasAl(<?= $registroId ?>)">
        Guardar
    </button>
</div>
<!--fin de apoyo a la agencia de los alumnos-->
...
<div class="form-group"> 
    ...
    <button type="submit" class="btn btn-outline-warning" 
            style="margin-top: 10px"
            onclick="grabarRecursos(<?= $registroId ?>)">
        Guardar
    </button>
</div>
...
<div class="form-group"> 
    ...
    <button type="submit" class="btn btn-outline-warning" 
            style="margin-top: 10px"
            onclick="grabarAutoeval(<?= $registroId ?>)">
        Guardar
    </button>
</div>
<!--fin de Hacer uso flexible de los recursos-->
...
<div class="form-group"> 
    ...
    <button type="submit" class="btn btn-outline-warning" 
            style="margin-top: 10px"
            onclick="grabarContinua(<?= $registroId ?>)">
        Guardar
    </button>
</div>
...
<div class="form-group"> 
    ...
    <button type="submit" class="btn btn-outline-warning" 
            style="margin-top: 10px"
            onclick="grabarAdicionales(<?= $registroId ?>)">
        Guardar
    </button>
</div>

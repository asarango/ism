...
/**
 * This is the model class for table "op_violence_type".
 *
 * @property int $id
 ...
 */
class OpViolenceType extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(OpPsychologicalAttention::className(), ['violence_type_id' => 'id']);
    }

...
/**
 * This is the model class for table "op_substance_use".
 *
 * @property int $id
 ...
 */
class OpSubstanceUse extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(OpPsychologicalAttention::className(), ['substance_use_id' => 'id']);
    }

...
/* @var $searchModel backend\models\PlanPduParametrosSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Parámetros de PDU';
$pdfTitle = $this->title;
...
?>
<div class="plan-pdu-parametros-index">

    <div class="container">

    <p>
        <?= Html::a('Crear Parámetros', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'hover'=>true,
        'responsive'=>true,
        'panel'=>['type'=>'primary', 'heading'=>'Listado de parámetros de PDU'],

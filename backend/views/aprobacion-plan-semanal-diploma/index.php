            ...
            <div style="margin-top: -20px;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="adv icon icon-tabler icon-tabler-eye-check" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6f32be" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                </svg> En el coordinador
                            </div>

                            <div class="col-lg-3 col-md-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="aler icon icon-tabler icon-tabler-clipboard-off" width="20" height="20" 
                            ...
                            <div class="col-lg-3 col-md-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="adv icon icon-tabler icon-tabler-alert-triangle" 
                                    title="El profesor no ha enviado su panificación" width="24" height="24" viewBox="0 0 24 24" 
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" 
                                    class="icon icon-tabler icon-tabler-file-certificate" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" 
                                ...
                                ?>
                                    <td style="font-size: 10px;">
                                        ...
                                        if ($estado === 'COORDINADOR') {
                                            echo '<a id="ver-plan-link" href="aprobar-plan-semanal?semana_id=' . $sem->id . '&docentes=' . $docente['login'] . '&trimestre_name=' . $trimestre->name .  '">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="adv icon icon-tabler icon-tabler-eye-check" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6f32be" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                    <path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
                                                    <path d="M11.102 17.957c-3.204 -.307 -5.904 -2.294 -8.102 -5.957c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6a19.5 19.5 0 0 1 -.663 1.032" />
                                            ...
                                            echo '<a id="ver-plan-link" href="aprobar-plan-semanal?semana_id=' . $sem->id . '&docentes=' . $docente['login'] . '&trimestre_name=' .  $trimestre->name . '">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="aler icon icon-tabler icon-tabler-clipboard-off" 

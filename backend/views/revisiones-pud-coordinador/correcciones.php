    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <?php echo Html::a('Puds para revision', ['revisiones-pud/index']); ?>
            </li>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="row well">
                    ...
                    <?php echo Html::a('ENVIAR VICERRECTOR', ['enviarvicerrector', 'pudId' => $modelPud->id], ['class' => 'btn btn-success form-control']); ?>
                </div>
            </div>

...
class PdfPlanSemana extends \yii\db\ActiveRecord
{
    private $claseId;
    private $modelClase;
    private $periodo;
    ...
    public function __construct($claseId, $semanaId, $usuario, $periodId)
    {     
    ...
    private function primera_parte(){
        ...
        $html .= '<th class="fondoTh border">Curso:</th>';
        $html .= '<td class="centrarTexto border">'.
                    $this->modelClase->paralelo->course->name.'  "'.$this->modelClase->paralelo->name.
                '</td>';
        $html .= '</tr>';

        $html .= '<th class="fondoTh border">ASIGNATURA:</th>';
        $html .= '<td class="centrarTexto border">'.
                    $this->modelClase->ismAreaMateria->materia->nombre;
                '</td>';
        $html .= '</tr>';

...
class ScholarisPlanPudDetalleController extends Controller {
    ...
    public function actionIndex1() {
        ...
        $modelClase = \app\models\ScholarisClase::findOne($modelPud->clase_id);
    ...
    protected function toma_destrezas_pci($codigoCurso, $pudId, $codigoMat) {
        $con = Yii::$app->db;
        $query = "select destreza_codigo, concat(destreza_codigo,' : ',destreza_detalle) as destreza_detalle, destreza_codigo

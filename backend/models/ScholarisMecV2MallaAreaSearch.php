...
/**
 * ScholarisMecV2MallaAreaSearch represents the model behind the search form of `backend\models\ScholarisMecV2MallaArea`.
 */
class ScholarisMecV2MallaAreaSearch extends ScholarisMecV2MallaArea
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'asignatura_id', 'malla_id','orden'], 'integer'],
            [['codigo','tipo'], 'safe'],
    ...
    {
        $query = ScholarisMecV2MallaArea::find()

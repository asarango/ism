...
/* @var $searchModel backend\models\PlanNivelSubSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Sub-Niveles de Educación';
$pdfTitle = $this->title;
...
?>
<div class="plan-nivel-sub-index">
    <div class="container">
    ...
    <p>
        <?= Html::a('Create Plan Nivel Sub', ['create','id' => $id], ['class' => 'btn btn-success']) ?>
    </p>

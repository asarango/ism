 ...
 */
class InfSabanaPdfQ1PN extends \yii\db\ActiveRecord {
...
//                if ($nf['bloque'] == 'q1') 
            ...
            $notasCompProy = $this->consulta_comportamientos_y_proyectos($alumno['id']);
            if($this->modelParalelo->course->section0->code != 'BACHILLERATO'){
                $html .= '<td class="conBorde" align="center">' . $notasCompProy['proyectos_notaq1'] . '</td>';
            }
            
            $html .= '<td class="conBorde" align="center">' . $notasCompProy['comportamiento_notaq1'] . '</td>';

    ...
    private function titulo_reporte() {
        ...
        if ($this->totalParciales > 4) {
            ...
            switch ($this->quimestre) {
                case 'p1':
                    $this->tituloReporte = 'INFORME DEL PARCIAL 1 DE APRENDIZAJE Y COMPORTAMIENTO';
                    break;

                case 'p2':
                    $this->tituloReporte = 'INFORME DEL PARCIAL 2 DE APRENDIZAJE Y COMPORTAMIENTO';
                    break;

                case 'p3':
                    $this->tituloReporte = 'INFORME DEL PARCIAL 3 DE APRENDIZAJE Y COMPORTAMIENTO';
                    break;

                case 'p4':
                    $this->tituloReporte = 'INFORME DEL PARCIAL 4 DE APRENDIZAJE Y COMPORTAMIENTO';
                    break;

                case 'p5':
                    $this->tituloReporte = 'INFORME DEL PARCIAL 5 DE APRENDIZAJE Y COMPORTAMIENTO';
                    break;
                case 'p6':
                    $this->tituloReporte = 'INFORME DEL PARCIAL 6 DE APRENDIZAJE Y COMPORTAMIENTO';
                    break;
                
                case 'ex1':
                    $this->tituloReporte = 'EXAMEN PRIMER QUIMESTRE';
                    break;
                
                case 'ex2':
                    $this->tituloReporte = 'EXAMEN SEGUNDO QUIMESTRE';
                    break;
            }
        } else {
            switch ($this->quimestre) {
...
//        $pie = $this->genera_pie_pdf();
    ...
    private function genera_cabecera() {
        ...
        $html .= '<strong>' . $this->tituloReporte . '</strong>';
        $html .= '</td>';
    ...
    private function detalle_alumnos() {
        ...
        foreach ($this->modelAlumnos as $alumno) {
            ...
            if ($this->seccion != 'BACHILLERATO') {
                ...
                isset($proyQ1[$this->quimestre]['abreviatura']) ? $notaPar = $proyQ1[$this->quimestre]['abreviatura'] : $notaPar = 0;
                
                $html .= '<td class="bordesolido tamano10 centrarTexto" bgcolor="#eaeaea">' . $notaPar . '</td>';
            ...
            $html .= '<td class="tamano10 bordesolido centrarTexto" bgcolor="#eaeaea" colspan="">' . $notaComportamiento . '</td>';

...
/**
 * This is the model class for table "op_external_derivation".
 *
 * @property int $id
 ...
 */
class OpExternalDerivation extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(OpPsychologicalAttention::className(), ['external_derivation_id' => 'id']);
    }
}

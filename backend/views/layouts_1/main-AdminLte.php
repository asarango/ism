...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <!--<link rel="stylesheet" href="DataTablesB4/datatables.min">-->
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-lg"><b>Educandi </b>- ZABYCA</span>
                </a>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <!--<img src="plantilla/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">-->
                            <img src="imagenes/instituto/logo/logo2.png" class="img-circle" alt="User Image">
                        </div>
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        if (!Yii::$app->user->isGuest) {
                            ...
                            foreach ($menus as $data) {
                                ...
                                <li class="treeview">
                                    <a href="#">
                                        <i class="fa fa-dashboard"></i> <span><?= $data['nombre'] ?></span>
...
<!--                                        <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2018-2025 <a href="http://www.zabyca.com:8069/">Zabyca Asociados CIA. LTDA.</a>.</strong> Todos los derechos reservados.
            </footer>

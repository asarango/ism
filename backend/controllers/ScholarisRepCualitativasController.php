 ...
 */
class ScholarisRepCualitativasController extends Controller {
...
//        $mpdf->addPage();
    ...
    private function genera_cabecera($paralelo, $bloque) {
        ...
        $cab .= '<p style="font-size:10px">CUADRO DE ASIGNATURAS CUALITATIVAS </p>';
    ...
    private function cuadro_notas_cabecera($paralelo, $bloque) {
        ...
        $clases = $sentencias->muestra_clases_cualitativas($paralelo);
        ...
        foreach ($modelAlumnos as $alumno) {
            ...
            foreach ($modelClases as $clase) {
                ...
                if(isset($modelNota)){
                    ...
                    $notaHomologada = $sentencia2->homologa_cualitativas($modelNota->calificacion);

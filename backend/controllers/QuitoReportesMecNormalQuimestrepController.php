 ...
 */
class QuitoReportesMecNormalQuimestrepController extends Controller {
    /**
     * {@inheritdoc}
     */
...
//
    ...
    private function genera_cabecera_pdf($paralelo) {
        ...
        $html .= '<tr>';
        $html .= '<td align="right" width="30%"><img src="imagenes/instituto/mec/educacion_nuevo.png" width="200"></td>';
    ...
    private function reporte_quimestre($paralelo, $quimestre, $campo) {
        ...
        $html .= '<tr>';
        $html .= '<td text-rotate="90" align="center" class="bordesolido"><div class="rotate" rowspan="2">ORD</div></td>';
        ...
        $html .= '<td align="center" class="bordesolido"><strong>OBSERVACIÓN</strong></td>';
        $html .= '</tr>';
        
        $html .= '<tr>';
        foreach ($materiasN as $mat) {
            $html .= '<td height="10" text-rotate="90" align="center" class="bordesolido tamano6">PROM</td>';
         }
        $html .= '</tr>';
        ...
        foreach ($modelAl as $al){
           ...
           $suma = 0;
            ...
            foreach ($materiasP as $normal){
                ...
                if($estado == 'M'){
                    $notaHomo = $sentencias2->homologa_cualitativas($notaMat);

 ...
 */
class ReportesMecNormalFinalController extends Controller {
    /**
     * {@inheritdoc}
     */
...
//        $html .= 'AÑO LECTIVO ' . $modelPeriodo->nombre . '<br>JORNADA MATUTINA</div>';
        ...
        $html .= '<td align="center" class="bordesolido" rowspan="2" width="200">NOMBRES Y APELLIDOS</td>';
...
//                
                ...
                $notaSup = $sentenciasMec->get_nota_quimestre_v2($al['id'], $normal['id'], 'supletorio', $paralelo);

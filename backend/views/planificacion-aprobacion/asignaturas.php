    ...
    <div class="m-0 vh-50 row justify-content-center align-items-center">
        <div class="card shadow col-lg-10 col-md-10">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12" style="display: flex; justify-content: start;">
                    <!-- <h6>-- Indicadores --</h6> -->
                            ...
                            <tbody>
                                ...
                                foreach ($asignaturas as $asignatura) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= $asignatura['fecha_envio_coordinador'] ?>
                                        </td>
                                        <td>
                                            <?= $asignatura['fecha_aprobacion_coordinacion'] ?>
                                        </td>
                                        <td>
                                            <?= $asignatura['fecha_de_cambios'] ?>
                                        </td>
                                        <td>
                                            <?=
                                                Html::a(

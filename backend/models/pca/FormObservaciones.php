...
class FormObservaciones extends \yii\db\ActiveRecord {
        ...
        $this->html .= '<div class="row">';
            $this->html .= '<div class="col-lg-12 col-md-12">';
                $this->html .= '<div style="text-align:center">';
                    $this->html .= '<h5 style="color:black"><strong>Observaciones</strong></h5>';
                $this->html .= '</div>';
            $this->html .= '</div>';
            $this->html .= '<hr>';
            ...
            $this->html .= '<div class="col-lg-12 col-md-12">';
                $this->html .= '<textarea class="form-control" placeholder="Escriba alguna observación" '
                                . 'onchange="ajaxSaveData(\''.null.'\',this,\'observaciones\')" '

...
/* @var $searchModel backend\models\PlanCurriculoObjetivosGeneralesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Objetivos generales de la evaluación';
$pdfTitle = $this->title;
$this->params['breadcrumbs'][] = ['label' => 'Evaluaciones', 'url' => ['plan-curriculo-distribucion/index']];
...
?>
<div class="plan-curriculo-objetivos-generales-index">
    ...
    <div class="alert alert-warning alert-dismissable">
        ...
        <?= $modelEvaluacion->criterio_evaluacion ?> 
    </div>
    </div>

    <p>
        <?= Html::a('Crear Objetivo General', ['create', 'id' => $modelEvaluacion->id], ['class' => 'btn btn-success']) ?>
    </p>

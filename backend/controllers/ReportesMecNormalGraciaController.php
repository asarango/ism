 ...
 */
class ReportesMecNormalGraciaController extends Controller {
    /**
     * {@inheritdoc}
     */
...
////        $mpdf->showImageErrors = true;
    ...
    private function reporte_quimestre($paralelo) {
        ...
        $html .= '<div align="center" class="tamano10">CUADRO FINAL CON GRACIA<br>';
...
//                
                ...
                $notaSup = $sentenciasMec->get_nota_quimestre_v2($al['id'], $normal['id'], 'gracia', $paralelo);

...
<div class="scholaris-bloque-actividad-view">
    ...
    <div class="m-0 vh-50 row justify-content-center align-items-center">
        <div class="card shadow col-lg-10 col-md-10">
            <div class=" row style=" style="margin-top: 10px;">
                <div class="col-lg-1">
            ...
            <div class="row" style="margin-top: 10px; margin-left: 40px">
                ...
                <div class="col-lg-6 col-md-6" style="background-color: #eee;padding: 10px; margin-bottom: 40px;">
                       <!-- botones "Actualizar/Borrar" -->
                    <p>
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <?= Html::a(
                        '<i class="fas fa-cogs"></i> Procesar semanas',
                        [
                            'process-weeks',
                            'bloque_id' => $model->id
                        ],

...
/**
 * This is the model class for table "op_special_needs".
 *
 * @property int $id
 ...
 */
class OpSpecialNeeds extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(OpPsychologicalAttention::className(), ['special_need_id' => 'id']);
    }

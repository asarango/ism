...
/* @var $searchModel backend\models\PlanCurriculoDestrezaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Destrezas';
$pdfTitle = $this->title;
$this->params['breadcrumbs'][] = ['label' => 'Distribucion', 'url' => ['plan-curriculo-distribucion/index']];
...
?>
<div class="plan-curriculo-destreza-index">
...
?>
    ...
    <div class="container">
        ...
        <p>
<?= Html::a('Create Plan Curriculo Destreza', ['create', 'id' => $modelDistribucion->id], ['class' => 'btn btn-success']) ?>
        </p>
...
//            'bloque_id',
        [
            ...
            'value' => function($model, $key, $index, $widget) {
                return $model->bloque->nombre;
            },
            'filterType' => GridView::FILTER_SELECT2,
            'filter' => ArrayHelper::map(PlanCurriculoBloque::find()
        ...
        [
            ...
            'width' => '150px',
            'vAlign' => 'middle',
            'template' => '{view}{update}{desempeno}',
            'buttons' => [
                'desempeno' => function($url, $model) {
                    return Html::a('<span class="glyphicon glyphicon-road"></span>', $url, [
                                'title' => 'Desempeño', 'data-toggle' => 'tooltip', 'role' => 'modal-remote', 'data-pjax' => "0", 'class' => 'hand'
                    ]);
                }
            ],
            'urlCreator' => function($action, $model, $key) {
                if ($action === 'desempeno') {
                    return \yii\helpers\Url::to(['plan-curriculo-desempeno/index1', 'id' => $key]);
                } else if ($action === 'view') {

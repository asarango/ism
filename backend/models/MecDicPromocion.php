 ...
 */
class MecDicPromocion extends \yii\db\ActiveRecord {
...
where	c.curso_id = $cursoId
    ...
    private function genera_cabecera() {
        ...
        isset($modelTituloUnoDistrito->valor) ? $titulo1 = $modelTituloUnoDistrito->valor : $titulo1 = 'Configurar en parámetros: parametro id = 10, codigo = tit1mec, Nombre=itulo uno de certificados mec, valor=nombre del distrito';
        ...
        $html .= '<td class="centrarTexto"><img src="imagenes/instituto/mec/educacion_nuevo.png" width="200px"></td>';
...
//                    
        ...
        if($this->tieneProyectos <> 0){
            ...
            $html .= '<tr>';
                ...
                $html .= '<td class="bordesolido" colspan=""><strong>PROYECTOS ESCOLARES</strong></td>';
                $html .= '<td class="bordesolido centrarTexto" colspan="">'.$notaPTransformada.'</td>';
                $html .= '<td class="bordesolido" colspan="">'.$notaP['q2']['abreviatura'].'</td>';
            $html .= '</tr>';
        }

...
<div class="portal-inicio-actividades">
                                    ...
                                    foreach ($modelActividades as $actividad) {
                                        ...
                                        <tr>
                                            ...
                                            if ($actividad->calificado == 'SI') {
                                                $modelTotal = $sentencia->toma_total_calificados($actividad->id);

                                                if ($modelTotal['total'] == $totalAlu) {
                                                    echo '<td bgcolor="#E7FA9F">' . $modelTotal['total'] . '</td>';
                                                } else {
                                                    echo '<td bgcolor="#FF0000">' . $modelTotal['total'] . '</td>';
                                                }
                                            } else {
                                                echo '<td>--</td>';
                                            }

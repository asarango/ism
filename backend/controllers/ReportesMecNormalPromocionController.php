 ...
 */
class ReportesMecNormalPromocionController extends Controller {
    /**
     * {@inheritdoc}
     */
...
//        $html .= 'SUBSECRETARÍA DE EDUCACIÓN DEL DISTRITO METROPOLITANO DE QUITO <br>';
        ...
        $html .= '<p class="">DISTRITO EDUCATIVO: ' . $model->institute->codigo_distrito . '</p>';
        $html .= '<p>CERTIFICADO DE PROMOCIÓN</p>';
        $html .= '<p>AÑO LECTIVO ' . $modelPeriodo->nombre . '</p>';
        $html .= '<p>JORNADA MATUTINA</p>';
        $html .= '</td>';
        $html .= '</tr>';
    ...
    private function detalle_alumno($alumno, $paralelo, $conareas) {
        ...
        $html .= 'De conformidad con lo prescrito en el Art. 197 del Reglamento General a la Ley Orgánica de '
                ...
                . ' del ' . $modelParalelo->course->name . ', PARALELO "' . $modelParalelo->name . '" , obtuvo las siguientes calificaciones durante el
...
//        $html .= '</table>';
    ...
    private function consecuencia($curso, $promedio, $totalBajos) {
        ...
        $texto2 = '. Para certificar suscriben en unidad de acto el/la Rector/a con el/ la Secretario/a General del Plantel.';

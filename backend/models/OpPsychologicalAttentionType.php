...
/**
 * This is the model class for table "op_psychological_attention_type".
 *
 * @property int $id
 ...
 */
class OpPsychologicalAttentionType extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'op_psychological_attention_type';
    }
    ...
    {
        return $this->hasMany(OpPsychologicalAttention::className(), ['attention_type_id' => 'id']);
    }

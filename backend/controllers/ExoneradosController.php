...
class ExoneradosController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $modelParametrosEscala = \backend\models\ScholarisParametrosOpciones::find()->where(['codigo' => 'scala'])->one();
        
        $notaConEscala = $notaMiminaExoneracion * $modelParametrosEscala->valor;
        

        return $this->render('index', [
            'modelCursos' => $modelCursos,
            'notaConEscala' => $notaConEscala
        ]);
    }
    ...
    public function actionReporte(){
        ...
        $notaExo    = $_POST['notaexoneracion'];
                                
        new \backend\models\InfExoneradosPdf($paraleloId, '', 'q2',$notaExo);

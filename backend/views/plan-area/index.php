...
/* @var $searchModel backend\models\PlanAreaSearch */
...
//                        return "<span class='badge' style='background-color: {$model->color}'> </span>  <code style='background-color: {$model->color}'>" .
//                                $model->color . '</code>';
                        return "<code style='background-color: {$model->color}'>" .$model->color. '</code>';
                    },

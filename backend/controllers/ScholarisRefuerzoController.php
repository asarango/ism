...
//        print_r($_GET);
    ...
    public function actionDelete($id)
    {
        ...
        $model = ScholarisRefuerzo::findOne($id);
        
        $clase = $model->grupo->clase_id;
        $orden = $model->bloque->orden;
        
        
        $this->findModel($id)->delete();

        return $this->redirect(['scholaris-actividad/parcial','clase'=>$clase, 'orden'=>$orden]);
    }

...
<div class="dece-intervencion-compromiso-form">
    ...
    <input class="form-control" hidden="false" type="text" id="id_intervencion" name="id_intervencion"
        value="<?= $id_intervencion ?>">
    <div class="row">

        <div class="col-lg-2">
            <label style='font-size:14px;' for="fecha_max_cumplimiento">Trimestre:</label><br>
        ...
        <div class="col-lg-2">
            ...
            <select id="tipo_compromiso" name="tipo_compromiso" class="form-select" aria-label="Default select example"
                style="width: 150px;">
                <?php
                $cont = 0;
        ...
        <div class="col-lg-6">
            ...
            <textarea class="form-control" id="text_detalle" name="text_detalle" aria-label="With textarea"
                rows="1"></textarea>
        </div>
        <div class="col-lg-2">
            ...
            <input type="date" id="fecha_max_cumplimiento" class="form-control" name="fecha_max_cumplimiento"
                require="true" value="<?= $fechaActual; ?>">
        </div>
    </div>
    <br>

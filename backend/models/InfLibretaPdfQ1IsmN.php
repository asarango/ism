 ...
 */
class InfLibretaPdfQ1IsmN extends \yii\db\ActiveRecord {
...
//        $sentenciasNotasAlumnos = new NotasAlumnos($this->paralelo, $this->quimestre, $alumnoId);
        ...
        foreach ($areas as $ar) {
            ...
            if ($ar['se_imprime'] == true) {
                ...
                if ($ar['promedia'] == 1) {                    
                    ...
                    $equivalencia = $this->homologa_aprovechamiento($notasArea['q1']);
            ...
            foreach ($materias as $mat) {
                ...
                $equivalencia = $this->homologa_aprovechamiento($notasM['q1']);
                $html .= '<td class="bordesolido tamano8 centrarTexto">' . $equivalencia . '</td>';
        ...
        $equivalencia = $this->homologa_aprovechamiento($notaF['q1']);
        $html .= '<td class="bordesolido tamano8 centrarTexto">' . $equivalencia . '</td>';

                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <button style="font-size: 10px; border-radius: 0px;" id="btnGroupDrop1"
                                            type="button" class="btn btn-outline-warning btn-sm dropdown-toggle"
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <li>
                                                <?= Html::a(
                                                    'Sábana Digital',
                                                    ['reporte-sabana-profesor/index1', 'id' => $clase['clase_id']],
                                            ...
                                            <li>
                                                <?= Html::a(
                                                    'Actividades',
                                                    ['profesor-inicio/actividades', 'id' => $clase['clase_id']],
                                                    ['class' => 'dropdown-item', 'style' => 'font-size:10px']
                                                )
                                                    ?>
                                            </li>
                                            ...
                                            <li>
                                                <?= Html::a(
                                                    'Best Fit - PAI',
                                                    ['scholaris-notas-pai/index1', 'id' => $clase['clase_id']],
                                                    ['class' => 'dropdown-item', 'style' => 'font-size:10px']
                                                )
                                                    ?>
                                            </li>

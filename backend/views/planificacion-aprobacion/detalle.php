                                ...
                                <div class="accordion accordion-flush my-text-medium" id="accordionFlushExample">
                                    ...
                                    ?>
                                            <div class="accordion-item">
                                                ...
                                                <div id="flush-collapse<?= $bloque['id'] ?>" class="accordion-collapse collapse" style="color: black" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                            ...
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                <div class="accordion accordion-flush my-text-medium scroll-400 " id="accordionFlushExample">
                                    ...
                                    ?>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="flush-headingOne">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsePv<?= $pv['id'] ?>" aria-expanded="false" aria-controls="flush-collapseOne">

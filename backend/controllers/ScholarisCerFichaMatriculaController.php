 ...
 */
class ScholarisCerFichaMatriculaController extends Controller {
    ...
    private function literal_c($alumno, $paralelo) {
        ...
        $html .= '<tr>';
        $html .= '<td align="center" class="tamano10"><strong>'.$modelFirmas->principal_nombre.'</strong></td>';
        $html .= '<td></td>';
        ...
        $html .= '<tr>';
        $html .= '<td align="center" class="tamano10"><strong>'.$modelFirmas->principal_cargo.'</strong></td>';
        $html .= '<td></td>';
        ...
        $html .= '<tr>';
        $html .= '<td></td>';
        $html .= (isset($representante)) ? '<td align="center" class="tamano10"><strong>_________________________________________</strong></td>':'<td></td>';
        $html .= '<td></td>';
        $html .= '</tr>';
        
        $html .= '<tr>';
        $html .= '<td></td>';
        $html .= (isset($representante)) ? '<td align="center" class="tamano10"><strong>' . $representante->name . '</strong></td>':'<td></td>';
        $html .= '<td></td>';
        $html .= '</tr>';
        
        $html .= '<tr>';
        $html .= '<td></td>';
        $html .= (isset($representante)) ? '<td align="center" class="tamano10"><strong>Representante</strong></td>':'<td></td>';
        $html .= '<td></td>';
        $html .= '</tr>';

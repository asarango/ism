 ...
 */
class InfSabanaExcelFinal extends \yii\db\ActiveRecord {
    ...
    private function genera_reporte_pdf() {
        ...
        $filename = 'SabanaFinal-HojaElectronica.xls';
...
//        exit;
    ...
    private function genera_cuerpo() {
        ...
        $html .= '<table style="font-size: 10px;" cellspacing="0" width="100%" border="1">';
        $html .= '<tr>';
